...
| `dashboard.image.tag`                             | Dashboard image tag (immutable tags are recommended)                                         | `2.4.5-debian-10-r23`        |
...
| `pinnipedProxy.image.tag`                             | Pinniped Proxy image tag (immutable tags are recommended)                                    | `2.4.5-debian-10-r22`             |
...
| `postgresql.auth.username`               | Name for a custom user to create (overrides `auth.username`)                 | `kubeapps` |
| `postgresql.auth.password`               | Password for the custom user to create (overrides auth.password)             | `""`       |
...
| `kubeappsapis.image.tag`                                                                        | Kubeapps-APIs image tag (immutable tags are recommended)                                                            | `2.4.5-debian-10-r22`   |
